...
#
# This script deals with spaces in file/directory names by changing the internal field separator (IFS), see https://stackoverflow.com/questions/1574898/bash-and-filenames-with-spaces
