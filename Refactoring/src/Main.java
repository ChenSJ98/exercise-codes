...
public class Main {
    public static void main (String[] args) {
        ...
        C1.addRental(new Rental(, new Rental.DateRange(M1, null)));
        C1.addRental(new Rental(, new Rental.DateRange(M2, null)));
        C1.addRental(new Rental(, new Rental.DateRange(M3, null)));
        ...
        C2.addRental(new Rental(, new Rental.DateRange(start, null)));
        C2.addRental(new Rental(, new Rental.DateRange(start, null)));
