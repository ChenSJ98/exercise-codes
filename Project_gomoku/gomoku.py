...
#chessboard_size, color, time_out passed from agent
    ...
    point_danger_COLOR_BLACK = {
        ...
        # (COLOR_NONE,COLOR_BLACK,COLOR_BLACK,COLOR_BLACK,COLOR_BLACK,COLOR_WHITE):1000000,
        #(COLOR_BLACK,COLOR_NONE,COLOR_BLACK,COLOR_BLACK,COLOR_BLACK):100000000,
        #(COLOR_BLACK,COLOR_BLACK,COLOR_NONE,COLOR_BLACK,COLOR_BLACK):100000000,
        #(COLOR_BLACK,COLOR_BLACK,COLOR_BLACK,COLOR_NONE,COLOR_BLACK):100000000,
        # (COLOR_WHITE,COLOR_BLACK,COLOR_BLACK,COLOR_BLACK,COLOR_BLACK,COLOR_NONE):1000000,
        # (COLOR_NONE,COLOR_BLACK,COLOR_BLACK,COLOR_BLACK,COLOR_NONE):35000
    }
    point_danger_COLOR_WHITE = {
        ...
        # (COLOR_NONE,COLOR_WHITE,COLOR_WHITE,COLOR_WHITE,COLOR_WHITE,COLOR_BLACK):1000000,
        # (COLOR_WHITE,COLOR_NONE,COLOR_WHITE,COLOR_WHITE,COLOR_WHITE):100000000,
        # (COLOR_WHITE,COLOR_WHITE,COLOR_NONE,COLOR_WHITE,COLOR_WHITE):100000000,
        # (COLOR_WHITE,COLOR_WHITE,COLOR_WHITE,COLOR_NONE,COLOR_WHITE):100000000,
        # (COLOR_WHITE,COLOR_WHITE,COLOR_WHITE,COLOR_WHITE,COLOR_NONE,COLOR_BLACK):1000000,
        # (COLOR_NONE,COLOR_WHITE,COLOR_WHITE,COLOR_WHITE,COLOR_NONE):35000
    }
    #class gobang:
    ...
    def getValue(self,cb2,pos,color):
        ...
        return total
    def h(self,cbx,searchSet,color):
        candidates = Q.PriorityQueue()
        sSet = copy.deepcopy(searchSet)
        for pos in sSet:
            score = self.getValue(cbx,pos,color)
    ...
    def minimax(self,chessboard,depth,maxPlayer):
        cboard = copy.deepcopy(chessboard)
        searchSet = self.genSet(chessboard)
        if (depth == 1 or len(searchSet) == 1):
            # print("end node")
            self.show(cboard)
            if maxPlayer:
                # print("return")
                return self.h(chessboard,searchSet,self.color)
            else:
                # print("return")
                return self.h(chessboard,searchSet,self.otherColor(self.color))
            ...
            if(maxPlayer):
                ...
                for pos in searchSet: # maximize player
                    ...
                    score, pos1 = self.minimax(subBoard, depth-1,False)
                    # print("return from recursive call")
                    score = -score
                    if(value < score):
                        value = score
                        solution = pos
                return tuple([-value, solution])
            else:
                value = float("inf")
                solution = [0,0]
                for pos in searchSet: # minimize player
                    subBoard = copy.deepcopy(cboard)
                    subBoard[pos[0],pos[1]] = self.color
                    score, pos1 = self.minimax(subBoard, depth-1,True)
                    score = -score
                    if(value > score):
                        value = score
                        solution = pos
    ...
    def go(self, chessboard):
        ...
        if len(searchSet) == 0:
            ...
            print("call minimax")
            candidate=self.minimax(chessboard,2,True)
